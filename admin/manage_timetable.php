...
<body>
   <?php include"header.php";?>
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-user"></i> Manage Time-Table</h2>
...
<?php	
 ...
 <?php echo '<td class="center">
	...
	<a class="btn btn-info" href="edit_timetable.php?id=' . $id . '">
			<i class="glyphicon glyphicon-edit icon-white"></i> Edit</a>
   
	<a class="btn btn-danger" href="delete_timetable.php?id=' . $id . '" onclick="return confirm("Are You Sure to Detete ?")">
