    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-edit"></i> Add Trainer</h2>
            ...
            <div class="box-content">
				...
				<?php
function valid( $name, $address,$dob,$age,$email,$contact,$doj,$degree, $error)
{
?>
 ...
 <?php
		...
		echo $doj." ";
		echo $degree." ";
		echo $package." ".$package_type." ".$name1;

	                    	if ($name == '' || $address == '' || $dob == '' || $age=='' || $email=='' || $contact=='' || $doj=='' || $degree=='')
							{
									$error = 'Please enter the details!';
									valid($name,$address,$dob,$age,$email,$contact,$doj,$degree,$error);
							}
							else
							{
							...
							$path="trainer/$name1";
								if(move_uploaded_file($tname,$path)==true)
									{
mysql_query("INSERT INTO   `fitness`.`trainer`(`ID`,`name`,`address`,`gender`,`dob`,`age`,`email`,`contact`,`doj`,`degree`,`class_ID`,`class_type_ID`,`image`)VALUES (Null,'$name','$address','$gender','$dob','$age','$email','$contact','$doj','$degree','$package','$package_type','$name1')")or die(mysql_error());
