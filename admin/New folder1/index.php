            ...
            <form class="form-horizontal" action="" method="post">
                ...
                <fieldset>
                    ...
                    <div class="input-prepend">
                        <label class="remember" for="remember"><a href="forget.php">Forget Password</a></label>
                    </div>
                    <div class="clearfix"></div>
	...
	if ( $name == '' || $pwd=='')
							{
									...
									valid($name,$pwd,$error);
							}
							else
							{
								
								$sql="select * from admin_master where username='$name' && password='$pwd'";
								$ex=mysql_query($sql);	
