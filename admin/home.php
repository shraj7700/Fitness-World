...
<div class=" row">
    ...
    <div class="col-md-3 col-sm-3 col-xs-6">
        <a data-toggle="tooltip" class="well top-block" href="#">
			...
			<?php 	include"connect.php";
					...
					$rw1=mysql_num_rows($ex1);
			?>
            <div>Total Trainer</div>
            <div><?php echo $rw1;?></div>
        </a>
    </div>
    ...
    <div class="col-md-3 col-sm-3 col-xs-6">
        <a data-toggle="tooltip" class="well top-block" href="#">
			...
			<?php 	include"connect.php";
					$sql2="select * from package_type";
					$ex2=mysql_query($sql2);	
					$rw2=mysql_num_rows($ex2);
			?>
			<div>Total Package-Type</div>
            <div><?php echo $rw2;?></div>
        </a>
    </div>
    ...
    <div class="col-md-3 col-sm-3 col-xs-6">
        <a data-toggle="tooltip" title="12 new messages." class="well top-block" href="#">
			...
			<?php 	include"connect.php";
					...
					$ex3=mysql_query($sql3);	
					$rw3=mysql_num_rows($ex3);
			?>
            <div>Feedback</div>
            <div><?php echo $rw3;?></div>
        </a>
    </div>
</div>
</div>
