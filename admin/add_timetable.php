    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-edit"></i> Add Time-Table</h2>
...
?> <?php
				 ...
				 <div class="form-group">
					...
					<div class="form-group">
						...
						From<input type="time" class="form-control" id="exampleInputEmail1" name="from">To <input type="time" class="form-control" id="exampleInputEmail1" name="to">
					</div>
...
<?php
						...
						if(isset($_POST["submit"]))
                        {
							...
							$day=$_POST["day"];
							$from1=$_POST["from"];
							$from=date('h:i:s a', strtotime($from1));
							$to1=$_POST["to"];
							$to=date('h:i:s a', strtotime($to1));
							...
							{
mysql_query("INSERT INTO `fitness`.`timetable`(`ID`,`class`,`class_type`,`day1`,`from`,`to`)VALUES (Null,'$package','$package_type','$day','$from','$to')")or die(mysql_error());
